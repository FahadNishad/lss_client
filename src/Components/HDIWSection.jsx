...
const HDIWSection = ({setIsOpen, setNumber}) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Tailor your contest to your needs, via dozens of available formats and options.",
      button: false, // No button for this step
    },
    {
      stepNumber: "3",
      title: "Invite Your Players",
      description: "Share your contest digitally via email, text messaging, and across social media.",
      button: false, // No button for this step
    },
    {
      stepNumber: "4",
      title: "Enjoy the Fun",
      description: "Follow the contest on game day to see if your numbers lead you to glory!",
      button: false, // No button for this step
    },
  ];
  ...
  return (
    <div className='w-[90%] mx-auto'>
      <Container className="mb-4">
        <div className="text-center pb-4 mb-2 mx-auto" style={{ maxWidth: '800px' }}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-5 relative">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center mb-6 md:mb-0 md:w-1/5 relative">
              {/* Combined step number and details in the same column */}
              <div className="flex flex-col items-center relative">
                ...
                {step.button && (
                  <Button
                    ...
                    className="bg-[#6366f1] my-2 mx-4 text-white hover:bg-blue-700 transition duration-200"
