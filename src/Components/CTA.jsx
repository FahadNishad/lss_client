          ...
          <div className="row position-relative zindex-2 py-5 my-1 my-md-3">
            <div className="col-md-6">
              <div className="mx-auto" style={{ maxWidth: "440px" }}>
                <h2 className="h1 pb-1 pb-md-3 pb-lg-4">Get Started on Your League Square 59 Pool</h2>
                <div className="fs-lg d-md-none pb-3 pe-5">
                  <p className="d-flex mb-2">
                    League Square 59 is officially scheduled to kick off on Sunday, February 9th 2025 at Caesars Superdome in New
                    Orleans, Louisiana. Get started on your football squares contest for the biggest football game of the year.
                  </p>
                </div>
                <button
