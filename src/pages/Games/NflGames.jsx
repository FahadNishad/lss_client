...
const NFLGames = () => {
  ...
  const BASE_URL = `https://www.thesportsdb.com/api/v1/json/${API_KEY}/eventsnextleague.php?id=4391`; // NFL ID for TheSportsDB
  ...
  if (loading) {
    return <p className="text-center mt-10 text-lg">Loading NFL games...</p>;
  }
  ...
  return (
    <div className="w-full flex flex-col items-center mt-24">
      <h1 className="text-4xl font-bold mb-10">Upcoming NFL Games</h1>
